...
const parityGroups = [
  { id: "must", title: "Базовый рыночный паритет", subtitle: "Возможности, без которых продукт не соответствует ожиданиям рынка", items: [["Hosted checkout", "Базовый способ принять оплату на защищённой платёжной странице Cicada."], ["Invoices и payment links", "Создание счёта из кабинета или API со ссылкой, QR-кодом и сроком действия."], ["Единый Payment Intent", "Общая модель платежа для Dashboard, payment link, checkout и API-интеграций."], ["REST API", "Единая модель объектов, idempotency, versioning и понятная документация."], ["Подписанные webhooks и retries", "Проверяемая подпись, повторная доставка и журнал событий по платежу."], ["Rate lock", "Прозрачная фиксация курса и срока действия котировки."], ["Payment deviation handling", "Отдельные сценарии partial, underpayment и overpayment."], ["Приоритетная network matrix", "Основные цифровые активы в заранее утверждённых сетях."], ["Crypto и fiat settlement", "Расчёт с мерчантом в согласованном цифровом активе или доступной фиатной валюте."], ["Refunds", "Управляемый возврат с привязкой к исходному платежу и сетевой комиссии."], ["Dashboard и reconciliation", "Связь invoice, blockchain transaction, fees и settlement reference."], ["KYB, KYT и sanctions controls", "Контроль мерчанта и транзакций с понятными hold-статусами."], ["Прозрачное contracting entity", "Клиент понимает, с каким юридическим лицом заключён договор и кто оказывает услугу."]] },
  { id: "next", title: "Расширение платформы", subtitle: "Возможности, которые добавляются по мере развития прикладных продуктов", items: [["Постоянные deposit addresses", "Адреса, связанные с customer ID, для top-ups, iGaming и wallet-сценариев."], ["Mass payouts", "Пакетные выплаты с approvals, whitelist и статусом каждой операции."], ["Embedded checkout", "Встраивание оплаты в интерфейс мерчанта после стабилизации hosted checkout."], ["Расширенные refunds", "Частичные возвраты, дополнительные правила комиссий и автоматизация обработки."], ["Auto-conversion", "Автоматический обмен принятого актива по правилам мерчанта."], ["Roles, workspaces и approvals", "Разделение доступа и maker-checker для чувствительных операций."], ["CMS и e-commerce plugins", "Готовые подключения для выбранных платформ с управлением версиями."], ["Расширенный audit log", "История действий пользователей, решений и изменений настроек."]] },
  { id: "differentiate", title: "Дифференциаторы", subtitle: "Возможности для заметного и защищаемого отличия от рынка", items: [["Configurable conversion rules", "Правила обмена по активу, workspace, сумме и целевой валюте."], ["Payout links", "Получатель самостоятельно вводит проверенные реквизиты по защищённой ссылке."], ["Custom domains и white label", "Управляемый брендированный checkout без потери обязательных disclosures."], ["Web3 checkout", "WalletConnect, browser wallets и on-chain контекст для crypto-native продуктов."], ["Несколько юридических лиц", "Разные contracting entities и settlement profiles в одном workspace."], ["Finance-grade reconciliation", "Выгрузки, сверка и отчётность, рассчитанные на финансовые команды."], ["Compliance decision engine", "Настраиваемые правила, thresholds, evidence trail и case management."]] }
];
